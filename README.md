...
## The License
DropletRaffle and all "Droplet" plugins for the Spout platform are licensed under the [MIT License][License].

Copyright (c) 2012, Spout LLC <<http://www.spout.org/>>  

## Getting the Source
The latest and greatest source can be found here on [GitHub][Source].  
Download the latest builds from our [build server][Builds]. [![Build Status](http://build.spout.org/job/DropletRaffle/badge/icon)][Builds]

## Compiling the Source
DropletRaffle uses Maven to handle its dependencies.
...
Change the `config.yml` located under `plugins/DropletRaffle` as needed.
...
[Source]: https://github.com/Droplets/DropletRaffle
[Builds]: http://build.spout.org/job/DropletRaffle
